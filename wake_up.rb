def wake_up
  puts "I wake up to my alarm blasting First Impressions from First Date"
  puts "I shut off my alarm after jamming out to the music for a little bit"
  puts "I take a shower to clean my greasy hair"
